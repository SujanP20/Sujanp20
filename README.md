...
### Software Engineer & Full-Stack Developer | Python • Java • Flask • AWS | AI/ML Enthusiast
...
#### 🔁 [Skill Swap — Full-Stack Web App](https://github.com/Sujanp20/Skill-Swap)
A peer-to-peer skill exchange platform with real-time chat, video conferencing, and community forums.
**Stack:** Python • Flask • PostgreSQL • JavaScript • WebRTC • Socket.io • RESTful APIs

#### 🧠 [Diabetic Retinopathy Diagnosis — Explainable AI](https://github.com/Sujanp20/Diabetic-Retinopathy-XAI)
CNN-based deep learning model with Grad-CAM, SHAP & LIME for transparent medical AI diagnosis.
**Stack:** TensorFlow • Keras • OpenCV • Scikit-learn • Grad-CAM • SHAP • LIME • AWS

#### ⚡ [FastAPI Backend Project](https://github.com/Sujanp20/fastapi-backend-project)
RESTful API backend with Python, FastAPI, database integration, and deployment.
